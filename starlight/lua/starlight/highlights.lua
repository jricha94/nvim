local highlights = {
		...
		Pmenu = {fg = C.popup_fg, bg = C.popup_bg, },
		...
		Search = {fg = C.dark, bg = C.search_blue, },
		IncSearch = {fg = C.dark, bg = C.search_blue, },
